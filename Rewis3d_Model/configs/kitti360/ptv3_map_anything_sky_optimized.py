...
# Sky teacher settings
use_sky_teacher = True
# sky_teacher_weight = None  # Optional: explicit path to sky teacher checkpoint
...
hooks = [
    ...
    dict(type="SkyTeacherHook"),  # Must come after CheckpointLoader
